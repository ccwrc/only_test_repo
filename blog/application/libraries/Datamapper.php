...
class DataMapper implements IteratorAggregate {
	...
	public function DataMapper($id = NULL)
	{
		...
		if (isset($this->validation))
		{
			...
			{
				if (isset($this->validation[$key]['label']))
				{
					$this->validation[$key]['label']= t($this->validation[$key]['label']);
					print $this->validation[$key]['label']." ";
				}
			}
		}
		*/
	...
	public function save($object = '', $related_field = '')
	{
		...
		// Sprawdzenie czy jest funkcja _before_save() i jej wywolanie
		if (method_exists($this, '_before_save'))
		{
			call_user_func(array($this, '_before_save'));
		}
	...
	public function delete($object = '', $related_field = '')
	{
		if (empty($object) && ! is_array($object))
		{
			if ( ! empty($this->id))
			{
				...
				{
					call_user_func(array($this, '_before_delete'));
				}
